...
# Script: DR_calculation_time.r 
# By: Michael G. Harvey 
# Date: 20 February 2017

# A script to calculate DR statistics for the time threshold taxonomy.
...
outfile.names <- NULL
for (i in 1:100) {
	outfile.names[i] <- paste("./DR_results_time/", i, ".txt", sep="")
}

# Tree used for BAMM analyses
birdtree <- read.tree('Hackett_time_justgeneticdata.tre')
